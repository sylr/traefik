...
func testDatadogRegistry(t *testing.T, metricsPrefix string, datadogRegistry Registry) {
	...
	udp.ShouldReceiveAll(t, expected, func() {
		...
		datadogRegistry.EntryPointReqDurationHistogram().With(nil, "entrypoint", "test").Observe(10000)
		...
		datadogRegistry.RouterReqDurationHistogram().With(nil, "router", "demo", "service", "test", "code", strconv.Itoa(http.StatusOK)).Observe(10000)
		...
		datadogRegistry.ServiceReqDurationHistogram().With(nil, "service", "test", "code", strconv.Itoa(http.StatusOK)).Observe(10000)
