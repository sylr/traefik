...
func TestOpenTelemetry(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.desc, func(t *testing.T) {
			...
			registry.EntryPointReqDurationHistogram().With(nil, "entrypoint", "test3").Observe(10000)
			...
			registry.RouterReqDurationHistogram().With(nil, "router", "demo", "service", "test", "code", strconv.Itoa(http.StatusOK)).Observe(10000)
			...
			registry.ServiceReqDurationHistogram().With(nil, "service", "test", "code", strconv.Itoa(http.StatusOK)).Observe(10000)
			...
			registry.EntryPointReqDurationHistogram().With(nil, "entrypoint", "myEntrypoint").Observe(10000)
			registry.EntryPointReqDurationHistogram().With(nil, "entrypoint", "myEntrypoint").Observe(20000)
